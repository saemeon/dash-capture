    ...
    children=[
        ...
        html.Div(
            ...
            children=[
                ...
                html.P(
                    "width / height are visible form fields; the resolver maps them to capture_width / capture_height."
                ),
                wizard_controlled,
            ],
        ),
        html.Div(
            ...
            children=[
                ...
                html.P(
                    "No form field — dimensions pinned to 1200×800 at app construction. Wizard shows just Generate + Download."
                ),
                wizard_preset,
            ],
        ),
        html.Div(
            ...
            children=[
                ...
                html.P(
                    "plotly_strategy removes title and legend; offscreen clone is built at 1400×700 before capture."
                ),
                wizard_stripped,
            ],
        ),
